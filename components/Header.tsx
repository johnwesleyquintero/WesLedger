    ...
    <header className="bg-white border-b border-slate-200 sticky top-0 z-20 shadow-sm backdrop-blur-md bg-white/90">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        <div className="flex items-center gap-3">
           <div className="w-8 h-8 sm:w-9 sm:h-9 bg-slate-900 text-white flex items-center justify-center rounded-lg font-bold font-mono text-lg sm:text-xl shadow-lg shadow-slate-900/20">
             W
           </div>
           <div>
             <h1 className="text-lg sm:text-xl font-bold tracking-tight text-slate-900 leading-tight">WesLedger</h1>
             <div className="hidden xs:flex text-[10px] text-slate-500 uppercase tracking-widest font-semibold items-center gap-2">
                System v1.7
